...
INSERT INTO `user_roles` (`user_role_id`, `username`, `ROLE`) VALUES
 ...
 DROP TABLE IF EXISTS `spring-hibernate-db`.`authorities`;
CREATE TABLE  `spring-hibernate-db`.`authorities` (
  `user_role_id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(45) NOT NULL,
 ...
 select * from `authorities` (`user_role_id`, `username`, `authority`) VALUES
 (2, 'janardhan', 'ROLE_ADMIN'),
 (1, 'janardhan', 'ROLE_USER'),
 (3, 'narsaiah', 'ROLE_USER');
